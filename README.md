...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/5ffc30abdbc66e00150580f0
...
To start editing your site, you can use the Sanity interface at https://pleasant-pluto-c30ab.sanity.studio/.
...
Generated at `2021-01-11T11:04:27.432Z` by Stackbit version `0.3.42`.